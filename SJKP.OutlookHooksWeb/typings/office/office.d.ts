...
declare module Microsoft.Office.WebExtension {
    ...
    export class CastItem {
        ...
        toItemRead(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.Item;
        toItemCompose(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.ComposeItem;
        toMessage(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.Message;
        toMessageRead(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.Message;
        toMessageCompose(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.ComposeMessage;
        toMeetingRequest(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.MeetingRequest
        toAppointment(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.Appointment;
        toAppointmentRead(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.Appointment;
        toAppointmentCompose(item: Microsoft.Office.WebExtension.Item): Microsoft.Office.WebExtension.ComposeAppointment;

    }
} declare module Microsoft.Office.WebExtension {
    export class ComposeAppointment extends ComposeItem {

        requiredAttendees: ComposeRecipient;
        optionalAttendees: ComposeRecipient;

    }
} declare module Microsoft.Office.WebExtension {
    export class ComposeItem extends Item {
        subject: {
            getAsync(callback: (result: AsyncResult) => void): string;
    ...
    export class ComposeMessage extends ComposeItem {
    ...
    export class ComposeRecipient {
        getAsync(callback: (result: AsyncResult) => void);
        getAsync(asyncContext: any, callback: (result: AsyncResult) => void);
        setAsync(recipients: EmailAddressDetails[], callback?: (result: AsyncResult) => void);
        addAsync(recipients: EmailAddressDetails[], callback?: (result: AsyncResult) => void);
        setAddHelper(recipients: EmailAddressDetails[], args?: {}, isSet?: boolean, callback?: (result: AsyncResult) => void);
    }
}
...
declare module Microsoft.Office.WebExtension {
    ...
    export class Item {
        ...
        loadCustomPropertiesAsync(callback: any, usercontext?: any): void;
    }
}
declare module Microsoft.Office.WebExtension {
...
declare module Microsoft.Office.WebExtension {
    ...
    export var cast: {
        item: Microsoft.Office.WebExtension.CastItem
    };
    //}
}
declare module Microsoft.Office.WebExtension {
